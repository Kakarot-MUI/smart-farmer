...
export default function QuickAccessCards() {
  ...
  const features = [
    {
      id: 'predict-crop',
      title: t('quick.predictCrop'),
      description: t('quick.predictCropDesc'),
      icon: Sprout,
    ...
    {
      id: 'check-fertilizer',
      title: t('quick.checkFertilizer'),
      description: t('quick.checkFertilizerDesc'),
      icon: FlaskConical,
      href: '#fertilizer',
    ...
    {
      id: 'scan-disease',
      title: t('quick.scanDisease'),
      description: t('quick.scanDiseaseDesc'),
      icon: ScanLine,
      href: '#disease',
